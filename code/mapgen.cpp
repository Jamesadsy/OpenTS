...
/// <returns>Returns with the screen's result -- 1 if the player accepted the map, 2 if the
/// screen was canceled, and 0 if it could not be opened at all.</returns>
...
/// </summary>
static void Repaint_Map_Preview(void)
{
